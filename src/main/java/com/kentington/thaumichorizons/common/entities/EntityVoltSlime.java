...
public class EntityVoltSlime extends EntitySlime {
   ...
   public EntityVoltSlime(World p_i1742_1_) {
      super(p_i1742_1_);
   }
   ...
   public void setDead() {
      ...
      if(!super.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F) {
         ...
         for(int k = 0; k < j; ++k) {
            ...
            EntityVoltSlime entityslime = this.createInstance();
   ...
   protected EntityVoltSlime createInstance() {
      return new EntityVoltSlime(super.worldObj);
   }
}
