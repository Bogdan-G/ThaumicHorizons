...
public class ModelSoulSieve extends ModelBase {
   ...
   public ModelSoulSieve() {
      ...
      this.TopSide1 = new ModelRenderer(this, 0, 0);
      this.TopSide1.addBox(0.0F, 0.0F, 0.0F, 16, 6, 1);
      ...
      this.TopSide2 = new ModelRenderer(this, 0, 9);
      this.TopSide2.addBox(0.0F, 0.0F, 0.0F, 16, 6, 1);
      ...
      this.TopSide3 = new ModelRenderer(this, 0, 44);
      this.TopSide3.addBox(0.0F, 0.0F, 0.0F, 1, 6, 14);
      ...
      this.TopSide4 = new ModelRenderer(this, 0, 18);
      this.TopSide4.addBox(0.0F, 0.0F, 0.0F, 1, 6, 14);
      ...
      this.TopBottom = new ModelRenderer(this, 48, 0);
      this.TopBottom.addBox(0.0F, 0.0F, 0.0F, 14, 1, 14);
      ...
      this.Middle = new ModelRenderer(this, 32, 32);
      ...
      this.Bottom = new ModelRenderer(this, 32, 18);
      this.Bottom.addBox(0.0F, 0.0F, 0.0F, 4, 4, 4);
      ...
      this.Sand = new ModelRenderer(this, 72, 16);
      this.Sand.addBox(0.0F, 0.0F, 0.0F, 14, 3, 14);
      ...
      this.SieveSide4 = new ModelRenderer(this, 64, 36);
      this.SieveSide4.addBox(0.0F, 0.0F, 0.0F, 2, 1, 5);
      ...
      this.SieveSide3 = new ModelRenderer(this, 64, 36);
      this.SieveSide3.addBox(0.0F, 0.0F, 0.0F, 2, 1, 5);
      ...
      this.SieveSide2 = new ModelRenderer(this, 48, 18);
      this.SieveSide2.addBox(0.0F, 0.0F, 0.0F, 5, 1, 2);
      ...
      this.SieveSide1 = new ModelRenderer(this, 48, 18);
      this.SieveSide1.addBox(0.0F, 0.0F, 0.0F, 5, 1, 2);
      ...
      this.SieveCenter4 = new ModelRenderer(this, 36, 0);
      this.SieveCenter4.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2);
      ...
      this.SieveCenter3 = new ModelRenderer(this, 36, 0);
      this.SieveCenter3.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2);
      ...
      this.SieveCenter2 = new ModelRenderer(this, 32, 28);
      this.SieveCenter2.addBox(0.0F, 0.0F, 0.0F, 4, 1, 1);
      ...
      this.SieveCenter1 = new ModelRenderer(this, 32, 28);
      this.SieveCenter1.addBox(0.0F, 0.0F, 0.0F, 4, 1, 1);
      ...
      this.SieveOuter4B = new ModelRenderer(this, 62, 24);
      this.SieveOuter4B.addBox(0.0F, 0.0F, 0.0F, 4, 1, 1);
      ...
      this.SieveOuter4A = new ModelRenderer(this, 64, 32);
      this.SieveOuter4A.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3);
      ...
      this.SieveOuter3B = new ModelRenderer(this, 62, 24);
      this.SieveOuter3B.addBox(0.0F, 0.0F, 0.0F, 4, 1, 1);
      ...
      this.SieveOuter3A = new ModelRenderer(this, 64, 32);
      this.SieveOuter3A.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3);
      ...
      this.SieveOuter2A = new ModelRenderer(this, 64, 32);
      this.SieveOuter2A.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3);
      ...
      this.SieveOuter2B = new ModelRenderer(this, 62, 24);
      this.SieveOuter2B.addBox(0.0F, 0.0F, 0.0F, 4, 1, 1);
      ...
      this.SieveOuter1B = new ModelRenderer(this, 62, 24);
      this.SieveOuter1B.addBox(0.0F, 0.0F, 0.0F, 4, 1, 1);
      ...
      this.SieveOuter1A = new ModelRenderer(this, 64, 32);
      this.SieveOuter1A.addBox(0.0F, 0.0F, 0.0F, 1, 1, 3);
